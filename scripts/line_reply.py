...
def send_message(reply_token: str, user_id: str, messages: list, token: str) -> dict:
    ...
    return {"method": "reply", "status": resp["status"], "body": resp["body"], "error": True}
...
def main() -> None:
    ...
    result = send_message(reply_token, user_id, messages, token)
